...
import com.example.meus_gastos.domain.service.TituloService;
...
public class TituloController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TituloResponseDTO> cadastrar(@PathVariable Long id, @RequestBody TituloRequestDTO dto) {
